...
function assertMapping(mapping: ColumnMapping) {
  ...
  if (mapping.mode === "fullName") {
    ...
    throw new ValidationError("Map the First name column (or switch to the full-name column)");
  }
}
...
/** Step 3 — resolve and validate every row against the live directory without writing anything. */
...
/** Step 4 — create new recipients and update existing ones by email, collecting per-row outcomes. */
