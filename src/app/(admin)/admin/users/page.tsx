...
export default async function PlatformPeoplePage() {
  ...
  return (
    <>
      <PageHeader title={tr("Users")} description={tr("Every account, what it may do, and which workspaces it belongs to.")} />
      <PageBody className="space-y-5">
        ...
        <DataTable
          ...
          onRowHref={(person) => `/admin/users/${person.id}`}
