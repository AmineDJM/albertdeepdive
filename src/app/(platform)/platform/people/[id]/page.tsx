...
import { MemberControls } from "../../workspaces/[id]/member-controls";
  ...
  return (
    <>
      ...
      <PageBody className="space-y-6">
        <Link href="/platform/people" className="inline-flex items-center gap-1 text-xs text-muted-foreground hover:text-foreground">
        ...
        <section>
          ...
          <DataTable
            ...
            onRowHref={(workspace) => `/platform/workspaces/${workspace.organizationId}`}
