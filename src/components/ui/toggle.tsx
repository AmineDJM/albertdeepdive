...
const toggleVariants = cva(
  ...
  {
    variants: {
      variant: { default: "bg-transparent", outline: "border border-input bg-transparent shadow-xs" },
      size: { default: "h-8 min-w-8 px-2", sm: "h-7 min-w-7 px-1.5", lg: "h-9 min-w-9 px-2.5" },
    },
